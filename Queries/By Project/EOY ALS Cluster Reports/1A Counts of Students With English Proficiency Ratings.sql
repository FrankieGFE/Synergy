...
SELECT 
 ...
 FROM
APS.PrimaryEnrollmentsAsOf('2016-05-25')AS PE
INNER JOIN
...
FROM 
APS.PHLOTEAsOf('2016-05-25') AS PHL
INNER JOIN
APS.PrimaryEnrollmentsAsOf('2016-05-25') AS ENR
ON
...
UNION ALL
SELECT * FROM 
APS.PHLOTEAsOf('2016-05-25') AS PHL2) AS PHL
...
(
SELECT * FROM 
APS.LCEStudentsNeedingTestingAsOf('2016-05-25')
...
INNER JOIN APS.PrimaryEnrollmentsAsOf('2016-05-25') AS PRIM
ON
...
APS.PHLOTEAsOf('2016-05-25') AS PHL
INNER JOIN
APS.PrimaryEnrollmentsAsOf('2016-05-25') AS PRIM
ON
PHL.STUDENT_GU = PRIM.STUDENT_GU
INNER JOIN
APS.LCELatestEvaluationAsOf('2016-05-25') AS LCE
ON
