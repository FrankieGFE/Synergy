...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[APS].[LCEALS2ADISTRICT]'))
	EXEC ('CREATE VIEW APS.LCEALS2ADISTRICT AS SELECT 0 AS DUMMY')
GO

ALTER VIEW APS.LCEALS2ADISTRICT AS
