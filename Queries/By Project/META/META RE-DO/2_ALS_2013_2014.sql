...
,CASE 
				...
				WHEN [ENGLISH PROFICIENCY] = '' AND [ELL Eligible] = '' AND [Most Recent Test] NOT IN ('WAPT', 'SCREENER', 'PRE-LAS') AND [Test Date] < '20110630' THEN 'FEPE'
				WHEN [ENGLISH PROFICIENCY] = '' AND [ELL Eligible]  = ''  AND [Most Recent Test] NOT IN ('WAPT', 'SCREENER', 'PRE-LAS') AND [Test Date] BETWEEN '20110630' AND '20120630' THEN 'FEPM'
				WHEN [ENGLISH PROFICIENCY] = '' AND [ELL Eligible]  = ''  AND [Most Recent Test] NOT IN ('WAPT', 'SCREENER', 'PRE-LAS') AND [Test Date] > '20130630' THEN 'FEP'
