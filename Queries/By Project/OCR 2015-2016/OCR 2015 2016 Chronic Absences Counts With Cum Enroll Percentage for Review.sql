...
SELECT ABSENCES.*, ENROLLS.*
	,CAST(CUM_ENROLL_COUNT AS DECIMAL)/CAST(TOTAL_ABSENCES AS DECIMAL) AS PERCENT_OF_ENROLLMENT
 FROM (

SELECT SCHOOL_CODE, COUNT(*) AS CUM_ENROLL_COUNT  FROM 
(SELECT DISTINCT SIS_NUMBER, SCHOOL_CODE FROM
[ST_Production].[dbo].[STUDENT_SCHOOL_MEMBERDAYS_2015]
--WHERE SIS_NUMBER= 637843657
) AS T1
...
(SELECT 
	...
	, M_HIS_CHRONIC_ABS, M_AME_CHRONIC_ABS, M_ASI_CHRONIC_ABS, M_HI_PAC_CHRONIC_ABS, M_BLA_CHRONIC_ABS, M_WHI_CHRONIC_ABS, M_2_OR_MORE_CHRONIC_ABS, M_TOT_CHRONIC_ABS, M_DIS_CHRONIC_ABS, M_ELL_CHRONIC_ABS, M_504_CHRONIC_ABS
	, F_HIS_CHRONIC_ABS, F_AME_CHRONIC_ABS, F_ASI_CHRONIC_ABS, F_HI_PAC_CHRONIC_ABS, F_BLA_CHRONIC_ABS, F_WHI_CHRONIC_ABS, F_2_OR_MORE_CHRONIC_ABS, F_TOT_CHRONIC_ABS, F_DIS_CHRONIC_ABS, F_ELL_CHRONIC_ABS, F_504_CHRONIC_ABS
	,SUM([M_TOT_CHRONIC_ABS] + [F_TOT_CHRONIC_ABS]) AS TOTAL_ABSENCES
...
ON
ABSENCES.[School Code] = ENROLLS.SCHOOL_CODE
