...
SELECT 
 ...
 FROM 
APS.PrimaryEnrollmentsAsOf('20170208') AS PRIM
LEFT JOIN 
APS.LCEEverELLStudentAsOf('20170208') AS ELL
ON
PRIM.STUDENT_GU = ELL.STUDENT_GU
INNER JOIN
APS.LCELatestEvaluationAsOf('20170208') AS TEST
ON
...
LEFT JOIN 
APS.LCEStudentsAndProvidersAsOf('20170208') AS LCE
ON
