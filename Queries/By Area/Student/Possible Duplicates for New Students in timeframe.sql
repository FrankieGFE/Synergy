 ...
 * It then ranks the 2 students on a set of criteria, and assigns a number.  We then threshold
 *
 * It is important to note that if there is a glut of new kids, the query takes a long time (exponentially based on the number of new kids) 
 *
 * Stats: for about 300 new kids, it takes about 40 seconds to run. (20 days back in october)
 */
DECLARE @NewStudentDayInterval INT = 10 -- Number of days back to search for new students
