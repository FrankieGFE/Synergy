...
WHERE
    ...
    AND [Student].[EXPECTED_GRADUATION_YEAR]=2015
...
UPDATE
    ...
    ,[GRADUATION_DATE]=CASE WHEN [GRADUATION_DATE] IS NULL THEN '2015-05-22' ELSE [GRADUATION_DATE] END
