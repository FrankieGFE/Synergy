...
SELECT [﻿SynSISNUMBER], ATTEND_PERMIT_CODE, ATTEND_PERMIT_DATE,NXTYR.STUDENT_SCHOOL_YEAR_GU
	,CASE WHEN NXTYR.SIS_NUMBER IS NULL THEN 'NO 2016 ENROLLMENT' ELSE '' END AS NEEDS_SSY 
	,ROW_NUMBER() OVER (PARTITION BY [﻿SynSISNUMBER] ORDER BY NXTYR.STUDENT_SCHOOL_YEAR_GU) AS RN
