...
SELECT [APS ID], ATTEND_PERMIT_CODE, ATTEND_PERMIT_DATE,PRIM.STUDENT_SCHOOL_YEAR_GU
	,CASE WHEN NXTYR.SIS_NUMBER IS NULL THEN 'NO 2017 ENROLLMENT' ELSE '' END AS NEEDS_SSY 
	,ROW_NUMBER() OVER (PARTITION BY [APS ID] ORDER BY NXTYR.STUDENT_SCHOOL_YEAR_GU) AS RN
...
AND SSY.CHANGE_DATE_TIME_STAMP > '2017-03-12'
