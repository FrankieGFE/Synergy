...
SELECT 
	...
	,CASE 
		  ...
		  WHEN STU2.SIS_NUMBER = 103478491 THEN 'UPDATE'  
		  ...
		  WHEN ORG.ORGANIZATION_NAME IS NULL AND ORG2.ORGANIZATION_NAME IS NULL  AND STU2.SIS_NUMBER != 103478491 THEN 'NO PRIMARY ENROLLMENT'
		  WHEN STU2.SIS_NUMBER IS NOT NULL AND ORG2.ORGANIZATION_NAME IS NOT NULL THEN 'UPDATE'
...
(
SELECT * FROM 
APS.PrimaryEnrollmentDetailsAsOf('2017-07-24')
WHERE
