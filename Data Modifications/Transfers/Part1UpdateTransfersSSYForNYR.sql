...
SELECT 
	...
	,CASE 
		    ...
		    -- per Patti, P1, P2, PK CREATE ERROR MESSAGE 'NO PRIMARY ENROLLMENT'
		  WHEN 
		  (CASE WHEN GRADEL22.VALUE_DESCRIPTION IS NOT NULL THEN GRADEL22.VALUE_DESCRIPTION ELSE GRADEL.VALUE_DESCRIPTION END) IN ('P1', 'P2', 'PK')  THEN 'NO PRIMARY ENROLLMENT'
		  ...
		  WHEN NXTYRENR2.SCHOOL_CODE = [App Loc] THEN '2016 Enrollment at APP LOC'
		  WHEN NXTYRENR.SCHOOL_CODE =  [App Loc] THEN '2016 Enrollment at APP LOC'
...
LEFT JOIN
APS.PrimaryEnrollmentsAsOf('2016-05-22') AS PE
ON
...
(
SELECT * FROM 
APS.PrimaryEnrollmentDetailsAsOf('2016-07-22')
WHERE
