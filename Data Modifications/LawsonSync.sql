...
UPDATE 
	ST_Stars.rev.REV_PERSON
SET		
	GENDER = UPDATEPERSON.LAW_GENDER
	, BIRTH_DATE = UPDATEPERSON.LAW_BIRTHDATE
	, ETHNIC_CODE = UPDATEPERSON.LAW_ETHNIC_CODE
	, HISPANIC_INDICATOR = UPDATEPERSON.LAW_HISPANIC_INDICATOR
	, PRIMARY_PHONE = UPDATEPERSON.LAW_PHONE
...
WHERE
	PERSON_GU = UPDATEPERSON.STAFF_GU
