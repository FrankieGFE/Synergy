...
------------------------------------------------------------------------------------------------------
-- HARD-CODED VALUES TO CHANGE OR UPDATE IN THIS SCRIPT:  

	--EXPECTED CREDIT RANGES
	--EXPECTED GRADUATION YEAR
	--SCHOOL YEAR
	--EXTENSION
	--SCHOOL CODES TO SKIP
-----------------------------------------------------------------------------------------------------
...
FROM 
	 (
SELECT EVERYTHING.*, [NewGrade].VALUE_DESCRIPTION AS UPDATED_GRADE_LEVEL 
...
,
			CASE 
				-- WHEN  EXPECTED_GRADUATION_YEAR =2021  THEN 190
				 WHEN  EXPECTED_GRADUATION_YEAR =2021  AND [Credits] < 6 THEN 190
				 WHEN  EXPECTED_GRADUATION_YEAR =2021  AND [Credits] BETWEEN 6 AND 12.99999 THEN 190
				 WHEN  EXPECTED_GRADUATION_YEAR =2021  AND [Credits] BETWEEN 13 AND 18.99999 THEN 190
				 WHEN  EXPECTED_GRADUATION_YEAR =2021  AND [Credits] >=19 THEN 190

				-- WHEN  EXPECTED_GRADUATION_YEAR =2020  THEN 200
				 WHEN  EXPECTED_GRADUATION_YEAR =2020  AND [Credits] <6 THEN 190
				 WHEN  EXPECTED_GRADUATION_YEAR =2020  AND [Credits] BETWEEN 6 AND 12.99999 THEN 200
				 WHEN  EXPECTED_GRADUATION_YEAR =2020  AND [Credits] BETWEEN 13 AND 18.99999 THEN 200
				 WHEN  EXPECTED_GRADUATION_YEAR =2020  AND [Credits] >=19 THEN 200

				-- WHEN  EXPECTED_GRADUATION_YEAR =2019  THEN 210
				 WHEN  EXPECTED_GRADUATION_YEAR =2019  AND [Credits] <6 THEN 190
				 WHEN  EXPECTED_GRADUATION_YEAR =2019  AND [Credits] BETWEEN 6 AND 12.99999 THEN 200
				 WHEN  EXPECTED_GRADUATION_YEAR =2019  AND [Credits] BETWEEN 13 AND 18.99999 THEN 210
				 WHEN  EXPECTED_GRADUATION_YEAR =2019  AND [Credits] >=19 THEN 210

				-- WHEN  EXPECTED_GRADUATION_YEAR =2018  THEN 220
				 WHEN  EXPECTED_GRADUATION_YEAR =2018  AND [Credits] <6 THEN 190
				 WHEN  EXPECTED_GRADUATION_YEAR =2018  AND [Credits] BETWEEN 6 AND 12.99999 THEN 200
				 WHEN  EXPECTED_GRADUATION_YEAR =2018  AND [Credits] BETWEEN 13 AND 18.99999 THEN 210
