...
/****** Object:  View [APS].[LCETeacherEndorsements]    Script Date: 10/12/2017 6:46:31 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	,CASE WHEN WAIVERS.STAFF_GU IS NOT NULL  AND CERT_AREA = '27' THEN 'W-27' 
		  ...
		  ,CASE WHEN NAVAJO.CERT_CODE = '0520' THEN 'Y' ELSE '' END AS [520]
 FROM 

(
SELECT 
	STAFF_GU
	,CASE WHEN [0200] = '0200' OR [0208] = '0208' OR [0250] = '0250' OR [0400] = '0400' OR [0408] = '0408' OR [0500] = '0500' OR [0505] = '0505'  THEN 'Y' ELSE '' END AS ELEM
	,CASE WHEN [0200] = '0200' OR [0208] = '0208' OR [0300] = '0300' OR [0308] = '0308' OR [0350] = '0350' OR [0400] = '0400' OR [0408] = '0408' OR [0500] = '0500' OR [0505] = '0505' OR [0800] = '0800'  THEN 'Y' ELSE '' END AS MID
	,CASE WHEN [0300] = '0300' OR [0308] = '0308' OR [0350] = '0350' OR [0400] = '0400' OR [0408] = '0408' OR [0500] = '0500' OR [0505] = '0505' OR [0800] = '0800'  THEN 'Y' ELSE '' END AS HIGH
 FROM 
	(
SELECT
	STAFF_GU, CERT_CODE
...
LEFT JOIN 
(SELECT DISTINCT STAFF_GU, CERT_CODE FROM 
REV.UD_LICENSURE_DATA
WHERE
CERT_CODE = '0520'
) AS NAVAJO
ON 
NAVAJO.STAFF_GU = LICENSES.STAFF_GU
