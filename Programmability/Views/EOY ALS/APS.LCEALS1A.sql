...
/****** Object:  View [APS].[LCEALS1A]    Script Date: 8/29/2017 10:32:58 AM ******/
SET ANSI_NULLS ON
GO
...
FROM 
APS.PHLOTEAsOf('2017-05-25') AS PHL
INNER JOIN
APS.PrimaryEnrollmentsAsOf('2017-05-25') AS ENR
ON
...
(	SELECT 
	...
	SELECT 
	 ...
	 FROM 
	APS.LCEStudentsAndProvidersAsOf('2017-05-25') AS ESL
	INNER JOIN
	rev.EPC_STU AS STU
	ON
...
UNION ALL
SELECT * FROM 
APS.PHLOTEAsOf('2017-05-25') AS PHL2) AS PHL
...
(
SELECT * FROM 
APS.LCEStudentsNeedingTestingAsOf('2017-05-25')
...
INNER JOIN APS.PrimaryEnrollmentsAsOf('2017-05-25') AS PRIM
ON
...
APS.PHLOTEAsOf('2017-05-25') AS PHL
INNER JOIN
APS.PrimaryEnrollmentsAsOf('2017-05-25') AS PRIM
ON
PHL.STUDENT_GU = PRIM.STUDENT_GU
INNER JOIN
APS.LCELatestEvaluationAsOf('2017-05-25') AS LCE
ON
