...
, STUFF((SELECT [*]= ', ' + sch1.SCHOOL_CODE 
                    ...
                    JOIN rev.REV_ORGANIZATION_YEAR oyr1  ON oyr1.ORGANIZATION_YEAR_GU = ssy1.ORGANIZATION_YEAR_GU
                                                           and oyr1.YEAR_GU IN (SELECT YEAR_GU FROM APS.YearDates WHERE GETDATE() BETWEEN YearDates.START_DATE AND YearDates.END_DATE AND EXTENSION = 'R')
...
JOIN rev.REV_ORGANIZATION_YEAR oyr  ON oyr.ORGANIZATION_YEAR_GU = ssy.ORGANIZATION_YEAR_GU
                                       and oyr.YEAR_GU IN (SELECT YEAR_GU FROM APS.YearDates WHERE GETDATE() BETWEEN YearDates.START_DATE AND YearDates.END_DATE AND EXTENSION = 'R')
