...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[APS].[BasicStudent]'))
	EXEC ('CREATE VIEW APS.BasicStudent AS SELECT 0 AS DUMMY')
GO

ALTER VIEW APS.BasicStudent AS
