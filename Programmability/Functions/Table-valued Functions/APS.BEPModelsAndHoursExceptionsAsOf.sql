...
/****** Object:  UserDefinedFunction [APS].[BEPModelsAndHoursExceptionsAsOf]    Script Date: 10/12/2017 6:05:39 PM ******/
SET ANSI_NULLS ON
GO
...
STEP2.*, STEP1.EL, STEP1.ORGANIZATION_GU, STEP1.SCHOOL_CODE,STEP1.GRADE FROM (
SELECT 
	*
...
SELECT 
	...
	, CASE 
			...
			WHEN  CRED.[520] = 'Y' AND LEFT(CRS.STATE_COURSE_CODE,4) BETWEEN '1232' AND '1234'  THEN 'Y' 
