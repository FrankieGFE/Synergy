...
CREATE FUNCTION [APS].[HRTeacherClassCountsAsOf](@AsOfDate DATETIME)
RETURNS TABLE
AS
RETURN
...
FROM 
	...
	GROUP BY SCHOOL_CODE, SCHOOL_NAME, BADGE_NUM, TEACHER_LAST_NAME, TEACHER_FIRST_NAME, GRADE, ORGANIZATION_GU