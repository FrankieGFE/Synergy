...
FROM
	...
	LEFT JOIN
	APS.LookupTable('K12.Enrollment','ENTER_CODE') AS ENTER_CODE -- Enter Code Description
	ON
	[StudentSchoolYear].ENTER_CODE = ENTER_CODE.[VALUE_CODE]
	
	LEFT JOIN
	APS.LookupTable('K12.Enrollment','LEAVE_CODE') AS [LEAVE_CODE] -- Leave Code Description
	ON
