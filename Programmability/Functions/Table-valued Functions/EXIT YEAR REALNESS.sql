...
(
SELECT 
	SIS_NUMBER, ADMIN_DATE, TEST_NAME, PERFORMANCE_LEVEL, TOTAL,EVER_ELL
...
FROM (
SELECT 
	SIS_NUMBER, ADMIN_DATE, TEST_NAME, PERFORMANCE_LEVEL,EVER_ELL
...
SELECT 
	STU.SIS_NUMBER, TEST.ADMIN_DATE, TEST_NAME, PERFORMANCE_LEVEL, IS_ELL
...
LEFT JOIN 
APS.LCEEverELLStudentAsOf(GETDATE()) AS ELL
ON
...
LEFT JOIN 
APS.LCEStudentsAndProvidersAsOf(GETDATE()) AS LCE
ON
