...
/****** Object:  UserDefinedFunction [APS].[NewBEPStudentsModelsAndHoursAsOf]    Script Date: 10/12/2017 4:42:53 PM ******/
SET ANSI_NULLS ON
GO
...
FROM (
SELECT DISTINCT SIS_NUMBER, STUDENT_GU, EL, SCHOOL_CODE, SECTION_ID
FROM
