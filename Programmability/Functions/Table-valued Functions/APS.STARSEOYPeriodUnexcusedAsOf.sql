...
/****** Object:  UserDefinedFunction [APS].[STARSEOYPeriodUnexcusedAsOf]    Script Date: 6/28/2017 12:05:14 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER FUNCTION [APS].[STARSEOYPeriodUnexcusedAsOf](@AsOfDate DATE)
RETURNS TABLE
AS
RETURN
