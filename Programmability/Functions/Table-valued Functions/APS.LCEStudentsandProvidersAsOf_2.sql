...
/****** Object:  UserDefinedFunction [APS].[LCEStudentsAndProvidersAsOf_2]    Script Date: 5/25/2017 10:00:55 AM ******/
SET ANSI_NULLS ON
GO
...
-- PULL ALL STUDENTS ESL AND BEP COURSE/SECTIONS AND IF IT IS QUALIFIED	
		LEFT JOIN 
		(
		--DECLARE @AsOfDate DATE = GETDATE()
		...
		, CASE WHEN QUALIFIED.COURSE_ID IS NULL THEN 'No Appropriate Credential' ELSE 'Y' END AS QUALIFIED_CLASS
		FROM 
