...
SET		
	...
	,LAST_NAME = CASE WHEN LAWSON.LAW_LAST_NAME LIKE 'MC%' THEN 'Mc' + UPPER(SUBSTRING(LAWSON.LAW_LAST_NAME,3,1)) + SUBSTRING(LAWSON.LAW_LAST_NAME,4,50) 
					  WHEN LAST_NAME LIKE 'Macintyre' THEN 'Mac' + UPPER(SUBSTRING(LAST_NAME,4,1)) + SUBSTRING(LAST_NAME,5,50)
				ELSE APS.FormatTitleCase(LAWSON.LAW_LAST_NAME) END
...
SET		
	CHANGE_DATE_TIME_STAMP = GETDATE()
	,CHANGE_ID_STAMP = @LAWSONGU
	,LAST_NAME = CASE WHEN LAST_NAME LIKE 'MC%' THEN 'Mc' + UPPER(SUBSTRING(LAST_NAME,3,1)) + SUBSTRING(LAST_NAME,4,50)
					WHEN LAST_NAME LIKE 'Macintyre' THEN 'Mac' + UPPER(SUBSTRING(LAST_NAME,4,1)) + SUBSTRING(LAST_NAME,5,50)
	 ELSE APS.FormatTitleCase(LAST_NAME) END 
