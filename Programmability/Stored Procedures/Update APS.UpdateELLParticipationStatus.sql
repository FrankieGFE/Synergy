...
/****** Object:  StoredProcedure [APS].[UpdateELLParticipationStatus]    Script Date: 8/17/2017 11:39:08 AM ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	CASE 
		-- PARENT REFUSAL MUST BE CURRENT YEAR
		WHEN PARENT_REFUSED = 'Y' AND PARENT_REFUSAL_STATUS = '' THEN 6
