...
SELECT
 ...
 , CASE WHEN GRADE='12' AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR
        WHEN GRADE='11' AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+1
		WHEN GRADE='10' AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+2
		WHEN GRADE='9'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+3
		WHEN GRADE='8'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+4
		WHEN GRADE='7'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+5
		WHEN GRADE='6'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+6
		WHEN GRADE='5'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+7
		WHEN GRADE='4'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+8
		WHEN GRADE='3'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+9
		WHEN GRADE='2'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+10
		WHEN GRADE='1'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+11
		WHEN GRADE='K'  AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+12
		WHEN GRADE='PK' AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+13
		WHEN GRADE='P2' AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+14
		WHEN GRADE='P1' AND EXPECTED_GRADUATION_YEAR IS NULL THEN SCHOOL_YEAR+15
	ELSE EXPECTED_GRADUATION_YEAR
	END                                                       AS [Class_Year]
...
JOIN rev.REV_YEAR AS YEARS                  ON YEARS.YEAR_GU              =OYR.YEAR_GU
