...
WHERE
1 = 1
       AND TEST_NAME IN ('SBA ES 2011 Plus','SBA MS 2011 Plus','SBA HS Science 2011+')
	   AND ADMIN_DATE = '04/01/2016'
	   AND SCORE_DESCRIPTION = 'SCALE'
	   AND PART_DESCRIPTION IN ('SBA HS Science 2011+','SCIENCE')
