...
SET 
	--AIMS.dbo.Construction_Schools_Cohort_IDs_And_Years.[DBA_Y-1-M] = DBA.[fld_Total_Score]
	AIMS.dbo.Construction_Schools_Cohort_IDs_And_Years.[DBA_Y-1-LA] = DBA.[fld_Total_Score]

FROM
	AIMS.dbo.Construction_Schools_Cohort_IDs_And_Years AS COHORT
	LEFT JOIN
	[db_DBA].[dbo].[tbl_DBA_Student_Results_2011_2012] AS DBA
	ON
	COHORT.ID_NBR = DBA.[fld_Student_ID]
WHERE
	COHORT.[COHORT YEAR] = 2013
	AND DBA.FLD_SCHOOL_YEAR = 2012
