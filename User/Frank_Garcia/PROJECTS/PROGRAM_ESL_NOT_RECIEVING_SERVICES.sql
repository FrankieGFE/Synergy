 ...
 * 
 * Initial Request:
 * ESL NOT RECIEVING SERVICES (ESL-R)
 * 
...
SELECT  
       ...
       , CONVERT(VARCHAR(10), nrs.ENTER_DATE, 120) AS [date_enrolled]
...
FROM   rev.EPC_STU                    stu
	   ...
	   JOIN APS.LCEStudentsAndProvidersAsOf (GETDATE()) nrs ON nrs.SIS_NUMBER = stu.SIS_NUMBER
WHERE  ssy.ENTER_DATE is not null
	   AND nrs.STATUS = 'No Appropriate Course Assigned'
