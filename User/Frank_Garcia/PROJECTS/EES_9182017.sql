...
DECLARE @EOC_HIST
	TABLE
		...
		,[ALGEBRA I 7 12 SY1617] NVARCHAR (50)
		,[ALGEBRA II 9 12 SY1617] NVARCHAR (50)
		,[ANATOMY AND PHYSIOLOGY 9 12 SY1617] NVARCHAR (50)
		,[BIOLOGY 9 12 SY1617] NVARCHAR (50)
		,[CHEMISTRY 9 12 SY1617] NVARCHAR (50)
		,[ECONOMICS 9 12 SY1617] NVARCHAR (50)
		,[ELA III READING 9 12 SY1617] NVARCHAR (50)
		,[ELA IV READING 9 12 SY1617] NVARCHAR (50)
		,[ENGLISH III WRITING 9 12 SY1617] NVARCHAR (50)
		,[ENGLISH IV WRITING 9 12 SY1617] NVARCHAR (50)
		,[ENVIRONMENTAL SCIENCE 9 12 SY1617] NVARCHAR (50)
		,[FINANCIAL LITERACY 9 12 SY1617] NVARCHAR (50)
		,[GEOMETRY 9 12 SY1617] NVARCHAR (50)
		,[NEW MEXICO HISTORY 9 12 SY1617] NVARCHAR (50)
		,[PRE-CALCULUS 9 12 SY1617] NVARCHAR (50)
		,[US GOVERNMENT COMPREHENSIVE 9 12 SY1617] NVARCHAR (50)
		,[US HISTORY 9 12 SY1617] NVARCHAR (50)
		,[PHYSICS 9 12 SY1617] NVARCHAR (50)
		,[WORLD HISTORY AND GEOGRAPHY 9 12 SY1617] NVARCHAR (50)
		)
INSERT INTO @EOC_HIST
SELECT
       SIS_NUMBER
       ,case when convert(float,[Algebra I 7 12 V001]) is null  THEN '' else case when convert(float,[Algebra I 7 12 V001]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [Algebra I 7 12 V001]
       ,case when convert(float,[Algebra I 7 12 V003]) is null  THEN '' else case when convert(float,[Algebra I 7 12 V003]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [Algebra I 7 12 v003]
       ,case when convert(float,[Algebra II 10 12 V002]) is null  THEN '' ELSE CASE WHEN  convert(float,[Algebra II 10 12 V002]) >= '14' THEN 'PASS' ELSE 'FAIL' END END AS [Algebra II 10 12 V002]
       ,CASE WHEN convert(float,[Algebra II 10 12 V006]) IS NULL THEN '' ELSE CASE WHEN convert(float,[Algebra II 10 12 V006]) >= '14' THEN 'PASS' ELSE 'FAIL' END END AS [Algebra II 10 12 V006]
       ,case when convert(float,[Anatomy Physiology 11 12 V002]) is null  THEN '' else case when convert(float,[Anatomy Physiology 11 12 V002]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS [Anatomy Physiology 11 12 V002]
       ,case when convert(float,[Biology 9 12 V002]) is null  THEN '' else case when convert(float,[Biology 9 12 V002]) >= '22' THEN 'PASS' ELSE 'FAIL' END END AS [Biology 9 12 V002]
       ,case when convert(float,[Biology 9 12 V003]) is null  THEN '' else case when convert(float,[Biology 9 12 V003]) >= '27' THEN 'PASS' ELSE 'FAIL' END END AS [Biology 9 12 V003]
       ,case when convert(float,[Biology 9 12 V007]) is null  THEN '' else case when convert(float,[Biology 9 12 V007]) >= '27' THEN 'PASS' ELSE 'FAIL' END END AS [Biology 9 12 V007]
       ,case when convert(float,[Chemistry 9 12 V001]) is null  THEN '' else case when convert(float,[Chemistry 9 12 V001]) >= '13' THEN 'PASS' ELSE 'FAIL' END END AS [Chemistry 9 12 V001]
       ,case when convert(float,[Chemistry 9 12 V002]) is null  THEN '' else case when convert(float,[Chemistry 9 12 V002]) >= '13' THEN 'PASS' ELSE 'FAIL' END END AS [Chemistry 9 12 V002]
       ,case when convert(float,[Chemistry 9 12 V003]) is null  THEN '' else case when convert(float,[Chemistry 9 12 V003]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [Chemistry 9 12 V003]
       ,case when convert(float,[Chemistry 9 12 V008]) is null  THEN '' else case when convert(float,[Chemistry 9 12 V008]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [Chemistry 9 12 V008]
       ,case when convert(float,[Economics 9 12 V001]) is null  THEN '' else case when convert(float,[Economics 9 12 V001]) >= '23' THEN 'PASS' ELSE 'FAIL' END END AS [Economics 9 12 V001]
       ,case when convert(float,[Economics 9 12 V004]) is null  THEN '' else case when convert(float,[Economics 9 12 V004]) >= '23' THEN 'PASS' ELSE 'FAIL' END END AS [Economics 9 12 V004]
       ,case when convert(float,[English Language Arts III Reading 11 11 V001]) is null  THEN '' else case when convert(float,[English Language Arts III Reading 11 11 V001]) >= '25' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts III Reading 11 11 V001]
       ,case when convert(float,[English Language Arts III Reading 11 11 V002]) is null  THEN '' else case when convert(float,[English Language Arts III Reading 11 11 V002]) >= '14' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts III Reading 11 11 V002]
       ,case when convert(float,[English Language Arts III Reading 11 11 V006]) is null  THEN '' else case when convert(float,[English Language Arts III Reading 11 11 V006]) >= '14' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts III Reading 11 11 V006]
       ,case when convert(float,[English Language Arts III Writing 11 11 V001]) is null  THEN '' else case when convert(float,[English Language Arts III Writing 11 11 V001]) >= '15' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts III Writing 11 11 V001]
       ,case when convert(float,[English Language Arts III Writing 11 11 V002]) is null  THEN '' else case when convert(float,[English Language Arts III Writing 11 11 V002]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts III Writing 11 11 V002]
       ,case when convert(float,[English Language Arts III Writing 11 11 V006]) is null  THEN '' else case when convert(float,[English Language Arts III Writing 11 11 V006]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts III Writing 11 11 V006]
       ,case when convert(float,[English Language Arts IV Reading 11 11 V003]) is null  THEN '' else case when convert(float,[English Language Arts IV Reading 11 11 V003]) >= '15' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts IV Reading 11 11 V003]
       ,case when convert(float,[English Language Arts IV Reading 12 12 V001]) is null  THEN '' else case when convert(float,[English Language Arts IV Reading 12 12 V001]) >= '15' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts IV Reading 12 12 V001]
       ,case when convert(float,[English Language Arts IV Writing 12 12 V001]) is null  THEN '' else case when convert(float,[English Language Arts IV Writing 12 12 V001]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts IV Writing 12 12 V001]
       ,case when convert(float,[English Language Arts IV Writing 12 12 V003]) is null  THEN '' else case when convert(float,[English Language Arts IV Writing 12 12 V003]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS [English Language Arts IV Writing 12 12 V003]
       ,case when convert(float,[Geometry 9 12 V003]) is null  THEN '' else case when convert(float,[Geometry 9 12 V003]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [Geometry 9 12 V003]
       ,case when convert(float,[New Mexico History 7 12 V001]) is null  THEN '' else case when convert(float,[New Mexico History 7 12 V001]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [New Mexico History 7 12 V001]
       ,case when convert(float,[New Mexico 7 12 History V004]) is null  THEN '' else case when convert(float,[New Mexico 7 12 History V004]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [New Mexico 7 12 History V004]
       ,case when convert(float,[New Mexico 7 12 History V001]) is null  THEN '' else case when convert(float,[New Mexico 7 12 History V001]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [New Mexico 7 12 History V001]
       ,case when convert(float,[Physics 9 12 V003]) is null  THEN '' else case when convert(float,[Physics 9 12 V003]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [Physics 9 12 V003]
       ,case when convert(float,[Pre-Calculus 9 12 V004]) is null  THEN '' else case when convert(float,[Pre-Calculus 9 12 V004]) >= '16' THEN 'PASS' ELSE 'FAIL' END END AS [Pre-Calculus 9 12 V004]
       ,case when convert(float,[Spanish Language Arts III Reading 11 11 V001]) is null  THEN '' else case when convert(float,[Spanish Language Arts III Reading 11 11 V001]) >= '14' THEN 'PASS' ELSE 'FAIL' END END AS [Spanish Language Arts III Reading 11 11 V001]
       ,case when convert(float,[Spanish Language Arts III Writing 11 11 V001]) is null  THEN '' else case when convert(float,[Spanish Language Arts III Writing 11 11 V001]) >= '15' THEN 'PASS' ELSE 'FAIL' END END AS [Spanish Language Arts III Writing 11 11 V001]
       ,case when convert(float,[US Government Comprehensive 9 12 V001]) is null  THEN '' else case when convert(float,[US Government Comprehensive 9 12 V001]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [US Government Comprehensive 9 12 V001]
       ,case when convert(float,[US Government Comprehensive 9 12 V002]) is null  THEN '' else case when convert(float,[US Government Comprehensive 9 12 V002]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [US Government Comprehensive 9 12 V002]
       ,case when convert(float,[US Government Comprehensive 9 12 V005]) is null  THEN '' else case when convert(float,[US Government Comprehensive 9 12 V005]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [US Government Comprehensive 9 12 V005]
       ,case when convert(float,[US History 9 12 V001]) is null  THEN '' else case when convert(float,[US History 9 12 V001]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS [US History 9 12 V001]
       ,case when convert(float,[US History 9 12 V002]) is null  THEN '' else case when convert(float,[US History 9 12 V002]) >= '31' THEN 'PASS' ELSE 'FAIL' END END AS [US History 9 12 V002]
       ,case when convert(float,[US History 9 12 V007]) is null  THEN '' else case when convert(float,[US History 9 12 V007]) >= '31' THEN 'PASS' ELSE 'FAIL' END END AS [US History 9 12 V007]
       ,case when convert(float,[World History And Geography 9 12 V001]) is null  THEN '' else case when convert(float,[World History And Geography 9 12 V001]) >= '25' THEN 'PASS' ELSE 'FAIL' END END AS[World History And Geography 9 12 V001]
       ,case when convert(float,[World History And Geography 9 12 V003]) is null  THEN '' else case when convert(float,[World History And Geography 9 12 V003]) >= '25' THEN 'PASS' ELSE 'FAIL' END END AS [World History And Geography 9 12 V003]
       ,case when convert(float,[Environmental Science 10 12 V001]) is null  THEN '' else case when convert(float,[Environmental Science 10 12 V001]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS[Environmental Science 10 12 V001]
       ,case when convert(float,[Financial Literacy 9 12 V003]) is null  THEN '' else case when convert(float,[Financial Literacy 9 12 V003]) >= '12' THEN 'PASS' ELSE 'FAIL' END END AS [Financial Literacy 9 12 V003]
       ,case when convert(float,[ALGEBRA I 7 12 SY1617]) is null  THEN '' else case when convert(float,[ALGEBRA I 7 12 SY1617]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS  [ALGEBRA I 7 12 SY1617]
       ,case when convert(float,[ALGEBRA II 9 12 SY1617]) is null  THEN '' else case when convert(float,[ALGEBRA II 9 12 SY1617]) >= '14' THEN 'PASS' ELSE 'FAIL' END END AS [ALGEBRA II 9 12 SY1617]
       ,case when convert(float,[ANATOMY AND PHYSIOLOGY 9 12 SY1617]) is null  THEN '' else case when convert(float,[ANATOMY AND PHYSIOLOGY 9 12 SY1617]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS [ANATOMY AND PHYSIOLOGY 9 12 SY1617]
       ,case when convert(float,[BIOLOGY 9 12 SY1617]) is null  THEN '' ELSE CASE WHEN convert(float, [BIOLOGY 9 12 SY1617]) >= '27' THEN 'PASS' ELSE 'FAIL' END END AS [BIOLOGY 9 12 SY1617]
       ,case when convert(float,[CHEMISTRY 9 12 SY1617]) is null  THEN '' else case when convert(float,[CHEMISTRY 9 12 SY1617]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [CHEMISTRY 9 12 SY1617]
       ,case when convert(float,[ECONOMICS 9 12 SY1617]) is null  THEN '' else case when convert(float,[ECONOMICS 9 12 SY1617]) >= '23' THEN 'PASS' ELSE 'FAIL' END END AS [ECONOMICS 9 12 SY1617]
       ,case when convert(float,[ELA III READING 9 12 SY1617]) is null  THEN '' else case when convert(float,[ELA III READING 9 12 SY1617] ) >= '14' THEN 'PASS' ELSE 'FAIL' END END AS [ELA III READING 9 12 SY1617]
       ,case when convert(float,[ELA IV READING 9 12 SY1617]) is null  THEN '' else case when convert(float,[ELA IV READING 9 12 SY1617]) >= '15' THEN 'PASS' ELSE 'FAIL' END END AS [ELA IV READING 9 12 SY1617]
       ,case when convert(float,[ENGLISH III WRITING 9 12 SY1617]) is null  THEN '' else case when convert(float,[ENGLISH III WRITING 9 12 SY1617]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [ENGLISH III WRITING 9 12 SY1617]
       ,case when convert(float,[ENGLISH IV WRITING 9 12 SY1617]) is null  THEN '' else case when convert(float,[ENGLISH IV WRITING 9 12 SY1617]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS [ENGLISH IV WRITING 9 12 SY1617]
       ,case when convert(float,[ENVIRONMENTAL SCIENCE 9 12 SY1617]) is null  THEN '' else case when convert(float,[ENVIRONMENTAL SCIENCE 9 12 SY1617]) >= '26' THEN 'PASS' ELSE 'FAIL' END END AS [ENVIRONMENTAL SCIENCE 9 12 SY1617]
       ,case when convert(float,[FINANCIAL LITERACY 9 12 SY1617]) is null  THEN '' else case when convert(float,[FINANCIAL LITERACY 9 12 SY1617]) >= '12' THEN 'PASS' ELSE 'FAIL' END END AS [FINANCIAL LITERACY 9 12 SY1617]
       ,case when convert(float,[GEOMETRY 9 12 SY1617]) is null  THEN '' else case when convert(float,[GEOMETRY 9 12 SY1617]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [GEOMETRY 9 12 SY1617]
       ,case when convert(float,[NEW MEXICO HISTORY 9 12 SY1617]) is null  THEN '' else case when convert(float,[NEW MEXICO HISTORY 9 12 SY1617]) >= '18' THEN 'PASS' ELSE 'FAIL' END END AS [NEW MEXICO HISTORY 9 12 SY1617]
       ,case when convert(float,[PRE-CALCULUS 9 12 SY1617]) is null  THEN '' else case when convert(float,[PRE-CALCULUS 9 12 SY1617]) >= '16' THEN 'PASS' ELSE 'FAIL' END END AS [PRE-CALCULUS 9 12 SY1617]
       ,case when convert(float,[US GOVERNMENT COMPREHENSIVE 9 12 SY1617]) is null  THEN '' else case when CONVERT(float,[US GOVERNMENT COMPREHENSIVE 9 12 SY1617]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [US GOVERNMENT COMPREHENSIVE 9 12 SY1617]
       ,case when convert(float,[US HISTORY 9 12 SY1617]) is null  THEN '' else case when convert(float,[US HISTORY 9 12 SY1617]) >= '31' THEN 'PASS' ELSE 'FAIL' END END AS [US HISTORY 9 12 SY1617]
       ,case when convert(float,[PHYSICS 9 12 SY1617]) is null  THEN '' else case when convert(float,[PHYSICS 9 12 SY1617]) >= '24' THEN 'PASS' ELSE 'FAIL' END END AS [PHYSICS 9 12 SY1617]
       ,case when convert(float,[WORLD HISTORY AND GEOGRAPHY 9 12 SY1617]) is null  THEN '' else case when convert(float,[WORLD HISTORY AND GEOGRAPHY 9 12 SY1617]) >= '25' THEN 'PASS' ELSE 'FAIL' END END AS [WORLD HISTORY AND GEOGRAPHY 9 12 SY1617]
FROM
(
SELECT 
       CAST (SIS_NUMBER AS INT) AS SIS_NUMBER
...
PIVOT
	(MAX ([TEST_SCORE]) FOR PART_DESCRIPTION IN 
		(
								...
								,[ALGEBRA I 7 12 SY1617]
								,[ALGEBRA II 9 12 SY1617]
								,[ANATOMY AND PHYSIOLOGY 9 12 SY1617]
								,[BIOLOGY 9 12 SY1617]
								,[CHEMISTRY 9 12 SY1617]
								,[ECONOMICS 9 12 SY1617]
								,[ELA III READING 9 12 SY1617]
								,[ELA IV READING 9 12 SY1617]
								,[ENGLISH III WRITING 9 12 SY1617]
								,[ENGLISH IV WRITING 9 12 SY1617]
								,[ENVIRONMENTAL SCIENCE 9 12 SY1617]
								,[FINANCIAL LITERACY 9 12 SY1617]
								,[GEOMETRY 9 12 SY1617]
								,[NEW MEXICO HISTORY 9 12 SY1617]
								,[PRE-CALCULUS 9 12 SY1617]
								,[US GOVERNMENT COMPREHENSIVE 9 12 SY1617]
								,[US HISTORY 9 12 SY1617]
								,[PHYSICS 9 12 SY1617]
								,[WORLD HISTORY AND GEOGRAPHY 9 12 SY1617]
								)) AS UP1
...
DECLARE @PARCC_AND_EOC
	TABLE
		...
		,[ALGEBRA I 7 12 SY1617] Varchar(50)
		,[ALGEBRA II 9 12 SY1617] Varchar(50)
		,[ANATOMY AND PHYSIOLOGY 9 12 SY1617] Varchar(50)
		,[BIOLOGY 9 12 SY1617] Varchar(50)
		,[CHEMISTRY 9 12 SY1617] Varchar(50)
		,[ECONOMICS 9 12 SY1617] Varchar(50)
		,[ELA III READING 9 12 SY1617] Varchar(50)
		,[ELA IV READING 9 12 SY1617] Varchar(50)
		,[ENGLISH III WRITING 9 12 SY1617] Varchar(50)
		,[ENGLISH IV WRITING 9 12 SY1617] Varchar(50)
		,[ENVIRONMENTAL SCIENCE 9 12 SY1617] Varchar(50)
		,[FINANCIAL LITERACY 9 12 SY1617] Varchar(50)
		,[GEOMETRY 9 12 SY1617] Varchar(50)
		,[NEW MEXICO HISTORY 9 12 SY1617] Varchar(50)
		,[PRE-CALCULUS 9 12 SY1617] Varchar(50)
		,[US GOVERNMENT COMPREHENSIVE 9 12 SY1617] Varchar(50)
		,[US HISTORY 9 12 SY1617] Varchar(50)
		,[PHYSICS 9 12 SY1617] Varchar(50)
		,[WORLD HISTORY AND GEOGRAPHY 9 12 SY1617] Varchar(50)
...
INSERT INTO @PARCC_AND_EOC
	...
	SELECT
		...
		,EOC_HIST.[ALGEBRA I 7 12 SY1617]
		,EOC_HIST.[ALGEBRA II 9 12 SY1617]
		,EOC_HIST.[ANATOMY AND PHYSIOLOGY 9 12 SY1617]
		,EOC_HIST.[BIOLOGY 9 12 SY1617]
		,EOC_HIST.[CHEMISTRY 9 12 SY1617]
		,EOC_HIST.[ECONOMICS 9 12 SY1617]
		,EOC_HIST.[ELA III READING 9 12 SY1617]
		,EOC_HIST.[ELA IV READING 9 12 SY1617]
		,EOC_HIST.[ENGLISH III WRITING 9 12 SY1617]
		,EOC_HIST.[ENGLISH IV WRITING 9 12 SY1617]
		,EOC_HIST.[ENVIRONMENTAL SCIENCE 9 12 SY1617]
		,EOC_HIST.[FINANCIAL LITERACY 9 12 SY1617]
		,EOC_HIST.[GEOMETRY 9 12 SY1617]
		,EOC_HIST.[NEW MEXICO HISTORY 9 12 SY1617]
		,EOC_HIST.[PRE-CALCULUS 9 12 SY1617]
		,EOC_HIST.[US GOVERNMENT COMPREHENSIVE 9 12 SY1617]
		,EOC_HIST.[US HISTORY 9 12 SY1617]
		,EOC_HIST.[PHYSICS 9 12 SY1617]
		,EOC_HIST.[WORLD HISTORY AND GEOGRAPHY 9 12 SY1617]
