...
SELECT	
	...
	,test_type_code
	,test_type_name
	,CASE WHEN test_section_name = '' THEN 'Instructional Recommendation' ELSE test_section_name
...
SELECT
	...
	,CASE
		...
		WHEN TEST_SECTION_NAME = 'Assessment Measure-Fluidez en la SegmentaciAn de Fonemas-Score' THEN 'FSF-TLP'
		WHEN TEST_SECTION_NAME = 'Assessment Measure-Fluidez en las Palabras sin Sentido-Score' THEN 'FPS-TSL'
