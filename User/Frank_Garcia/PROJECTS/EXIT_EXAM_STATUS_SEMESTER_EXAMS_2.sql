--select distinct MARK_NAME from rev.EPC_SCH_YR_GRD_PRD_MK 
--order by MARK_NAME--<APS - SchoolNet section_result  data>
; with GradeMark AS
(
   SELECT 
            stu.student_gu
...
WHERE sch.SCHOOL_CODE > '500'
and MARK_NAME = 'S1 Exam'
AND COALESCE(mk.MARK, chsm.MARK) NOT IN ('WF','N','W')
