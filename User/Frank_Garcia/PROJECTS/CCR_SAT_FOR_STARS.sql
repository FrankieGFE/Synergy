...
SELECT 
  ...
  FROM [180-SMAXODS-01].[SchoolNet].[dbo].[test_result_SAT] AS CCR
 -- LEFT JOIN
  ...
  LEFT JOIN
	...
	WHERE test_section_name IN ('Mathematics','Critical Reading','WRITING')
AND CCR.[school_year] = '2014'
) AS T1
WHERE
[STUDENT ID] IS NOT NULL
AND [RAW SCORE] != ''
AND [TEST DATE] > '2014-07-06'
AND RN = 1
