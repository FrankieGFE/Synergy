...
SELECT 
	...
	,test_type_name
	,CASE
		WHEN test_section_name = 'School #' THEN 'SNo1'
		WHEN test_section_name = 'School Name' THEN 'SNa2'
		WHEN test_section_name = 'Course' THEN 'Co3'
		WHEN test_section_name = 'Description' THEN 'De4'
		WHEN test_section_name = 'Course Grade' THEN 'CG5'
		WHEN test_section_name = 'Total Absences' THEN 'TA6'
		WHEN test_section_name = 'HS' THEN 'H'+ SCORE
		ELSE ''
	END AS test_section_code
	--,LEFT (Score, 3) AS test_section_name
	,CASE
		WHEN test_section_name IS NOT NULL THEN
		CASE 
			WHEN test_section_name = 'School #' THEN 'MS No.' 
			WHEN test_section_name = 'School Name' THEN 'MS Name'
			WHEN test_section_name = 'Course' THEN 'Course No.' 
			WHEN test_section_name = 'Description' THEN 'Course'
			WHEN test_section_name = 'Course Grade' THEN 'Grade'
			WHEN test_section_name = 'Total Absences' THEN 'Absences'
			WHEN test_section_name = 'HS' THEN 'TO' + ' ' + SCORE 
		ELSE 'N/A'
		END 
	...
	,CASE
		...
		WHEN test_section_name = 'HS' THEN SCORE 
		ELSE 'N/A'
	END AS  score_1
	,'' score_2
	,'' score_3
	...
	,CASE
		WHEN test_section_name = 'School #' THEN 'MS Location'
		WHEN test_section_name = 'School Name' THEN 'Middle School'
		WHEN test_section_name = 'Course' THEN 'Course Number'
		WHEN test_section_name = 'Description' THEN 'Course Name'
		WHEN test_section_name = 'Course Grade' THEN 'Course Grade'
		WHEN test_section_name = 'Total Absences' THEN 'Total Absences'
