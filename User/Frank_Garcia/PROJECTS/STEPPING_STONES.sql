...
SELECT
	...
	,'Math Quarterly Test - Modules 1-3' AS test_section_code
	,CASE WHEN assessment_name = '2014-2015 Fall Grade 2 Math Quarterly Test 4- Modules 1-3' THEN 'Math Quarterly Test - Modules 1-3'
		  WHEN assessment_name = '2014-2015 Fall Grade K Quarterly Math Test 4- Modules 1-3' THEN 'Math Quarterly Test - Modules 1-3'
		  WHEN assessment_name = '2014-2015 Fall Grade 1 Math Quarterly Test 1- Modules 1-3' THEN 'Math Quarterly Test - Modules 1-3'
		  WHEN assessment_name = '2014-2015 Fall Grade 5 Math Quarterly Test 1- Modules 1-3' THEN 'Math Quarterly Test - Modules 1-3'
		  WHEN assessment_name = '2014-2015 Fall Grade 3 Math Quarterly Test 1- Modules 1-3' THEN 'Math Quarterly Test - Modules 1-3'
		  WHEN assessment_name = '2014-2015 Fall Grade 4 Math Quarterly Test 1- Modules 1-3' THEN 'Math Quarterly Test - Modules 1-3'
	END AS test_section_name
	,'0' parent_test_section_code
	,CASE WHEN '0'+ SUBSTRING(assessment_name,22,1) = '0K' THEN 'K' 
		ELSE '0'+ SUBSTRING(assessment_name,22,1)
...
SELECT 
  ...
  WHERE assessment_id IN ('8261','8262','8274','8301','8302','8303')
  ) AS T1
  ...
  --and school_code = '203'
  --AND assessment_id IN ('8261','8262','8274','8301','8302','8303')
