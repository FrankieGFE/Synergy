...
SELECT 
	   ...
	   ,'1' AS 'DISTRICT CODE'
	   ,'PLAN' AS 'TEST DESCRIPTION'
	   ,'6/30/2013' AS 'ASSESSMENT SCHOOL YEAR DATE'
	   ,CASE	
			WHEN CCR.test_section_name = 'READING' THEN 'READING'
			WHEN CCR.test_section_name = 'MATH' THEN 'MATH'
  ...
  FROM [180-SMAXODS-01].[SchoolNet].[dbo].[TEST_RESULT] AS CCR
 -- LEFT JOIN
  ...
  LEFT JOIN
	...
	WHERE test_section_name IN ('READING','ENGLISH','MATH','SCIENCE')
