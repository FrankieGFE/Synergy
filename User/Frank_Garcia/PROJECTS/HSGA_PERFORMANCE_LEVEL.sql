...
SELECT
	...
	,version_code
	,CASE	
		WHEN section_name = 'SS_READ_FALL_2013' THEN READ_FALL_2013
		WHEN section_name = 'SS_MATH_FALL_2013' THEN MATH_FALL_2013
		WHEN section_name = 'SS_SCIENCE_FALL_2013' THEN SCIENCE_FALL_2013
		WHEN section_name = 'BEST_COMPOSITE_SUM' THEN BEST_COMPOSITE_SCORE
...
UNPIVOT (scaled_score FOR section_name IN (SS_READ_FALL_2013, SS_MATH_FALL_2013, SS_SCIENCE_FALL_2013,BEST_COMPOSITE_SUM
