SELECT DISTINCT
		...
		ROW_NUMBER () OVER (PARTITION BY pper.LAST_NAME, pper.FIRST_NAME ORDER BY stu.SIS_NUMBER) AS RN
...
WHERE PPER.LAST_NAME = 'GBARA' AND PPER.FIRST_NAME = 'PATIENCE'
ORDER BY
	pper.LAST_NAME , pper.FIRST_NAME 