...
(MAX(COMPETENCY) FOR SEMESTER IN ([2012 Fall],[2012 Spring],[2013 Fall],[2013 Spring],[2014 Fall],[2014 Spring],[2015 Fall],[2015 Spring],[2016 Fall],[2016 Spring])) AS PT1
	...
	ON SMS.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN SBA_MATH_PL AS SMPL
	ON SMPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN SBA_READING_SCORE AS SRS
	ON SRS.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN SBA_READING_PL AS SRPL
	ON SRPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN SBA_SCIENCE_SCORE AS SSS
	ON SSS.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN SBA_SCIENCE_PL AS SSPL
	ON SSPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN SBASPA_READING_SCORE AS SSRS
	ON SSRS.SIS_NUMBER =  STU.STATE_STUDENT_NUMBER

	LEFT JOIN SBASPA_READING_PL AS SSRPL
	ON SSRPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ALG01_SCORE AS PALG1S
	ON PALG1S.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ALG01_PL AS PALG1PL
	ON PALG1PL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ALG02_SCORE AS PALG2S
	ON PALG2S.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ALG02_PL AS PALG2PL
	ON PALG2PL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_GEO01_SCORE AS PGEO01S
	ON PGEO01S.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_GEO01_PL AS PGEO01PL
	ON PGEO01PL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ELA09_SCORE AS PELA09S
	ON PELA09S.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ELA09_PL AS PELA09PL
	ON PELA09PL.SIS_NUMBER =  STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ELA10_SCORE AS PELA10S
	ON PELA10S.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ELA10_PL AS PELA10PL
	ON PELA10PL.SIS_NUMBER =  STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ELA11_SCORE AS PELA11S
	ON PELA11S.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN PARCC_ELA11_PL AS PELA11PL
	ON PELA11PL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_READING_SCORE AS NREADINGS
	ON NREADINGS.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_READING_PL AS NREADINGPL
	ON NREADINGPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_MATH_SCORE AS NMATHS
	ON NMATHS.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_MATH_PL AS NMATHPL
	ON NMATHPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_SCIENCE_SCORE AS NSCIENCES
	ON NSCIENCES.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_SCIENCE_PL AS NSCIENCEPL
	ON NSCIENCEPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_SocialStudies_SCORE AS NSOCIALSTUDIESS
	ON NSOCIALSTUDIESS.SIS_NUMBER = STU.STATE_STUDENT_NUMBER

	LEFT JOIN NMAPA_SocialStudies_PL AS NSOCIALSTUDIESPL
	ON NSOCIALSTUDIESPL.SIS_NUMBER = STU.STATE_STUDENT_NUMBER


WHERE PED.GRADE IN ('09','10','11','12')
--AND STATE_STUDENT_NUMBER = '100003771'
...
--WHERE STATE_STUDENT_NUMBER = '162981195'
