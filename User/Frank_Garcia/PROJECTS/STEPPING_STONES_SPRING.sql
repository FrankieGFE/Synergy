...
SELECT
	...
	,'Math Quarterly Test- Modules 7-9' AS test_section_code
	,CASE WHEN assessment_name = '2014-2015 Spring Grade K Math Quarterly Test 2- Modules 7-9' THEN 'Math Quarterly Test- Modules 7-9'
		  WHEN assessment_name = '2014-2015 Spring Grade 1 Math Quarterly Test 4- Modules 7-9' THEN 'Math Quarterly Test- Modules 7-9'
		  WHEN assessment_name = '2014-2015 Spring Grade 2 Math Quarterly Test 1- Modules 7-9' THEN 'Math Quarterly Test- Modules 7-9'
		  WHEN assessment_name = '2014-2015 Spring Grade 3 Math Quarterly Test- Modules 7-9' THEN 'Math Quarterly Test- Modules 7-9'
		  WHEN assessment_name = '2014-2015 Spring Grade 4 Math Quarterly Test- Modules 7-9' THEN 'Math Quarterly Test- Modules 7-9'
		  WHEN assessment_name = '2014-2015 Spring Grade 5 Math Quarterly Test- Modules 7-9' THEN 'Math Quarterly Test- Modules 7-9'
...
SELECT 
  ...
  --and school_code = '203'
  WHERE assessment_id IN ('8327','8329','8331','8562','8563','8564')
