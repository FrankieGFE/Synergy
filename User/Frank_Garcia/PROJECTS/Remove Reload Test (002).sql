...
EXEC K12INTEL_METADATA.REMOVE_TESTSCORES 'ACT 001 APS 2015-2016 ACT_FEB'	 --'GENERIC SBA-NM 001 APS 2015-2016'		--If the name has changed, used the previous name here.
...
WHERE 1=1
    AND batch.BATCH_NAME in( 'ACT 001 APS 2015-2016 act_feb') --, 'GENERIC HSGA-Composite 001 APS 2015-2016')  --This is the folder structure; needs to be changed if the test is moved.
	

SELECT * FROM K12INTEL_USERDATA.XTBL_TEST_BATCH_IDS batch
WHERE BATCH_NAME LIKE '%ACT%'
----------------------------------------------------------------------------------------
--Run CScript
...
WHERE 1=1
	--AND tests.TEST_PRODUCT = 'ACT'
	AND CONVERT(DATE, scores.SYS_CREATED) = '04/21/2016'
