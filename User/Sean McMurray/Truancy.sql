...
Select
  ...
  ,rev.UD_TRUANCY_LOG.ADD_DATE_TIME_STAMP AS [Date Added]
...
From
  rev.UD_TRUANCY_LOG -- 10k
  INNER JOIN 
  rev.EPC_STU
  ON
  rev.EPC_STU.STUDENT_GU = rev.UD_TRUANCY_LOG.STUDENT_GU
...
ON
rev.UD_TRUANCY_LOG.OUTCOME_1 = OUTCOME1.VALUE_CODE
LEFT JOIN
APS.LookupTable('Revelation.UD.Truancy','Outcome_2') AS OUTCOME2
ON
rev.UD_TRUANCY_LOG.OUTCOME_2 = OUTCOME2.VALUE_CODE
LEFT JOIN
APS.LookupTable('Revelation.UD.Truancy','Truancy_Staff') AS STAFF
ON
rev.UD_TRUANCY_LOG.TRUANCY_STAFF = STAFF.VALUE_CODE
LEFT JOIN
APS.LookupTable('Revelation.UD.Truancy','Truancy_Staff_Title') AS TITLE
ON
rev.UD_TRUANCY_LOG.TRUANCY_STAFF_TITLE = TITLE.VALUE_CODE
LEFT JOIN
APS.LookupTable('revelation.ud.truancy','contact_with') AS CONTACT
ON
rev.UD_TRUANCY_LOG.CONTACT_WITH = CONTACT.VALUE_CODE
