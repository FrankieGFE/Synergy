...
SELECT 
	...
	,CASE WHEN ADDSTAFF.PRIMARY_TEACHER = 'N' THEN 'NONE' ELSE ADDSTAFF.LAST_NAME + ', ' + ADDSTAFF.FIRST_NAME END AS EA

	, STAFFSTUFF.DOCUMENT_NUMBER AS License
	,' WHAT IS OTHER LICENSE ' AS OtherLicense
...
GROUP BY 
	...
	,CASE WHEN ADDSTAFF.PRIMARY_TEACHER = 'N' THEN 'NONE' ELSE ADDSTAFF.LAST_NAME + ', ' + ADDSTAFF.FIRST_NAME END
