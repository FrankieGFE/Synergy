...
SELECT 
	...
	,CASE WHEN VALUE_DESCRIPTION = 'Advanced' THEN 'FEP Bridging/Reaching'
		  ...
		  WHEN VALUE_DESCRIPTION = 'Bridging' THEN 'Emerging'
		  WHEN VALUE_DESCRIPTION = 'Early Intermediate' THEN 'Developing'
		  ...
		  WHEN VALUE_DESCRIPTION = 'LEP' THEN 'Entering'
		  WHEN VALUE_DESCRIPTION = 'NEP' THEN 'Emerging'
