...
SELECT 
	...
	,CRED.AUTHORIZED_TCH_AREA AS [Teacher Endorsements]
	,CRED.CREDENTIAL_TYPE AS [Teacher Credentials]
	,0 AS ADD_STAFF
 FROM 
(
SELECT DISTINCT [APS_Teacher_ID], STAFFGU, [Teacher_Last_Name], [Teacher_First_Name]
...
ORDER BY [APS_Teacher_ID], ADD_STAFF
