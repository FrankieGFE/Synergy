...
FROM
            OPENROWSET (
                 ...
                 'Text;Database=\\SYNTEMPSSIS\Files\TempQuery;',
                  'SELECT * from LIVE_STREET2018.csv'
                ) AS [File]
...
ON
SCHOOL3.SCHOOL_CODE = LEFT(CAST([File].GridCode AS VARCHAR),3)


/*
ONLY CHANGE STUDENTS THAT ARE AT 497 OR IN 5TH GRADE AT 280 - 1/26/2018 

*/

WHERE
	(GRADEL.VALUE_DESCRIPTION = '05' AND LEFT(CAST([File].GridCode AS VARCHAR),3) = '280')
	OR
	LEFT(CAST([File].GridCode AS VARCHAR),3) = '497'
