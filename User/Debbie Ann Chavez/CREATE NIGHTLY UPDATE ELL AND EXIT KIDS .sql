		...
		--FROM (
			...
			SELECT 
				...
				,FIRSTTEST.ADMIN_DATE AS FIRSTTEST_ADMIN_DATE, FIRSTTEST.TEST_NAME AS FIRSTTEST_TEST_NAME, FIRSTTEST.PERFORMANCE_LEVEL AS FIRSTTEST_PERFORMANCE_LEVEL, FIRSTTEST.IS_ELL AS FIRSTTEST_IS_ELL
					...
					--2017-2018
					,CASE WHEN [2017].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20160701' THEN '2017' ELSE '' END AS [2017_EXIT]
					...
					--2016-2017
					,CASE WHEN [2016].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20150701' THEN '2016' ELSE '' END AS [2016_EXIT]
					...
					--2015-2016
					,CASE WHEN [2015].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20140701' THEN '2015' ELSE '' END AS [2015_EXIT]
					...
					--2014-2015
					,CASE WHEN [2014].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20130701' THEN '2014' ELSE '' END AS [2014_EXIT]
					...
					--2013-2014
					,CASE WHEN [2013].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20120701' THEN '2013' ELSE ''END AS [2013_EXIT]
					...
					--2012-2013
					,CASE WHEN [2012].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20110701' THEN '2012' ELSE '' END AS [2012_EXIT]
					...
					--2011-2012
					,CASE WHEN [2011].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20100701' THEN '2011' ELSE '' END AS [2011_EXIT]
					...
					--2010-2011
					,CASE WHEN [2010].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20090701' THEN '2010' ELSE '' END AS [2010_EXIT]
					...
					--2009-2010
					,CASE WHEN [2009].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20080701' THEN '2009' ELSE '' END AS [2009_EXIT]
					...
					--2008-2009
					,CASE WHEN [2008].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20070701' THEN '2008' ELSE '' END AS [2008_EXIT]
					...
					--2007-2008
					,CASE WHEN [2007].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20060701' THEN '2007' ELSE '' END AS [2007_EXIT]
					...
					--2006-2007
					,CASE WHEN [2006].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20050701' THEN '2006' ELSE '' END AS [2006_EXIT]
					...
					--2005-2006
					,CASE WHEN [2005].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20040701' THEN '2005' ELSE '' END AS [2005_EXIT]
					...
					--2004-2005
					,CASE WHEN [2004].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20030701' THEN '2004' ELSE '' END AS [2004_EXIT]
					...
					,CASE WHEN [2003].STUDENT_GU IS NOT NULL AND TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20020701' THEN '2003' ELSE '' END AS [2003_EXIT]
					...
					,CASE WHEN  TEST.IS_ELL = 0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20010701' THEN '2002' ELSE '' END AS [2002_EXIT]
					...
					,CASE WHEN TEST.IS_ELL =0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '20000701' THEN '2001' ELSE '' END AS [2001_EXIT]
					...
					,CASE WHEN TEST.IS_ELL =0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '19990701' THEN '2000' ELSE '' END AS [2000_EXIT]
					...
					,CASE WHEN TEST.IS_ELL =0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '19980701' THEN '1999' ELSE '' END AS [1999_EXIT]
					...
					,CASE WHEN TEST.IS_ELL =0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '19970701' THEN '1998' ELSE '' END AS [1998_EXIT]
					...
					,CASE WHEN TEST.IS_ELL =0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '19960701' THEN '1997' ELSE '' END AS [1997_EXIT]
					...
					,CASE WHEN TEST.IS_ELL =0 AND TEST.TEST_NAME NOT IN ('PRE-LAS', 'WAPT', 'SCREENER', 'SCRE') AND TEST.ADMIN_DATE < '19950701' THEN '1996' ELSE '' END AS [1996_EXIT]
			...
			2002-2003	3D95815E-93DB-4E7A-9741-4252AB7D1DAA -- NO ENROLLMENTS THIS YEAR LOADED TO SYNERGY
			2003-2004	A1A45208-69FC-4E58-99B3-7501E9108D70 -- FIRST YEAR IN SYNERGY
...
--WHERE STU.SIS_NUMBER = 100026566
