...
--     when '2017-02-08' > copt.END_DATE   then convert(varchar(10), copt.END_DATE, 101) 
--     else convert(varchar(10), '2017-02-08', 101)
--  end 
--as LeaveDate
...
--WHEN CHANGING THE YEAR, CHANGE THE CALENDAR YEAR TABLE
join dbo.CalDayTable			ct   on ct.OrgGU                   = oyr.ORGANIZATION_GU
                                       and ct.OrgYrGu             = oyr.ORGANIZATION_YEAR_GU
where ct.caldate between enr.ENTER_DATE and coalesce(CASE WHEN enr.leave_date > '2017-02-08' THEN '2017-02-08' ELSE enr.leave_date END , '2017-02-08')
...
LEFT JOIN 
APS.AttendanceExcUnexTotalsAsOf('2017-02-08') AS ATT
