...
SELECT
	COUNT (*) AS NUMBER_OF_HIGHSCHOOL_ELL
	,SUM(CASE WHEN ATTEND_SUMMER_SCHOOL = 'Y' THEN 1 ELSE 0 END) AS ATTENDED_SUMMER_SCHOOL
	,'' AS REMEDIATION_CLASS
	,SUM(CASE WHEN CREDIT_RECOVERY_COUNT IS NOT NULL THEN 1 ELSE 0 END) AS CREDIT_RECOVERY
	,SUM(CASE WHEN SHORT_DAY_SCHEDULE = 'Y' THEN 1 ELSE 0 END) AS SHORT_DAY_SCHEDULE
	,SUM(CASE WHEN ALTERNATE_HIGH_SCHOOL = 'Y' THEN 1 ELSE 0 END) AS ALTERNATE_HIGH_SCHOOL
	,SUM(CASE WHEN TOTAL_CTE_COURSES != 0 THEN 1 ELSE 0 END) AS CTE_COURSES
	,SUM(CASE WHEN DISTANCE_ED != 0 THEN 1 ELSE 0 END) AS DISTANCE_ED
	,SUM(CASE WHEN NEWLY_ENROLLED_OVER_18 = 'Y' THEN 1 ELSE 0 END) AS NEWLY_ENROLLED_OVER_18
