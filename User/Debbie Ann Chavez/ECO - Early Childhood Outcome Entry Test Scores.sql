...
SELECT
	...
	,CAST([StudentSchoolYear].[ENTER_DATE] AS DATE) AS ENTER_DATE
	,CAST([StudentSchoolYear].[LEAVE_DATE] AS DATE) AS LEAVE_DATE
...
SELECT --TOP 100
	...
	,CAST([ASOF_ENROLLMENTS].[ENTER_DATE] AS DATE) AS ENTER_DATE
	,CAST([ASOF_ENROLLMENTS].[LEAVE_DATE] AS DATE) AS LEAVE_DATE
	,[TEST].[TEST_NAME]
	,[TEST].[TEST_DESCRIPTION]
	--,[TEST].[SCHOOL_YEAR]
	,CAST([STUDENT_TEST].[ADMIN_DATE] AS DATE) AS ADMIN_DATE
...
FROM
	...
	FROM
		...
		rev.EPC_SCH AS SCH
		ON
		APS.StudentEnrollmentDetails.ORGANIZATION_GU = SCH.ORGANIZATION_GU
		
	WHERE
		[ENTER_DATE] BETWEEN '07/01/2015' AND '05/30/2016'
		--SCHOOL_YEAR = 2015
		--AND EXTENSION = 'R'
...
WHERE
	...
	AND [STUDENT_TEST].[ADMIN_DATE] BETWEEN '07/01/2015' AND '05/30/2016'
