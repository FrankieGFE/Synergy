...
SELECT 
	...
	,LUNCH_STATUS AS [Economic Disadvantage Status]
	,CASE WHEN PRIMARY_DISABILITY_CODE != 'GI' AND SPED_STATUS = 'Y' THEN 'Y' ELSE 'N' END AS [Student With Disabilities]
		...
		********************************************/
		...
		(SELECT 	
			...
			,CASE WHEN PRIM.GRADE = '08' AND SCH.COURSE_TITLE LIKE 'ALGEBRA%' THEN 'ALG' + '01'
					WHEN SCH.COURSE_TITLE NOT LIKE 'ALGEBRA%' AND SCH.DEPARTMENT = 'Math' THEN 'MAT' + PRIM.GRADE 
