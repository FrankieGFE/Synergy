...
/****** Object:  UserDefinedFunction [APS].[AttendanceAsOf]    Script Date: 6/15/2016 4:30:34 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [APS].[AttendanceAsOf](@AsOfDate DATETIME)
RETURNS TABLE
AS
RETURN
...
FROM
    [APS].[PeriodAbsencesAsOf](@asOfDate) AS [Period]
