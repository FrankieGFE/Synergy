...
SELECT 
	...
	,MAX(CASE WHEN [ENTER] = 'ELL' THEN FIRSTTEST_ADMIN_DATE ELSE NULL END) AS ENTER_ELL_DATE
	,MAX(CASE WHEN [EXIT] != 9999 AND RN = 1 THEN LATEST_ADMIN_DATE ELSE NULL END) AS CLOSE_OUT_ELL_DATE
