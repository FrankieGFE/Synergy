 ...
 * 9/1/2016
 *
 * This script refreshes ST_DEB on SynSecondDB with backups (integrating the weekly full and
 * dailys.  It then does some "cleanup" prepping the data file for use in 
 * non-production mode!
 */

 -- while performing the restore, we cannot be "focused" at ST_DEB
 USE master
...
ALTER DATABASE [ST_DEB] SET RECOVERY SIMPLE WITH NO_WAIT
