...
SELECT *
			...
			-- CHANGED THE LOGIC TO RETAIN STUDENTS IN SAME GRAD YEAR - DO NOT PROMOTE THEM BEYOND
,
			CASE 
				 WHEN /*SSY_GRADE = 190 AND*/ EXPECTED_GRADUATION_YEAR =2021  THEN 190
				 WHEN /*SSY_GRADE = 190 AND*/ EXPECTED_GRADUATION_YEAR =2021  AND [Credits] < 6 THEN 190
				 WHEN /*SSY_GRADE = 190 AND*/ EXPECTED_GRADUATION_YEAR =2021  AND [Credits] BETWEEN 6 AND 12.99999 THEN 190
				 WHEN /*SSY_GRADE = 190 AND*/ EXPECTED_GRADUATION_YEAR =2021  AND [Credits] BETWEEN 13 AND 18.99999 THEN 190
				 WHEN /*SSY_GRADE = 190 AND*/ EXPECTED_GRADUATION_YEAR =2021  AND [Credits] >=19 THEN 190

				 WHEN /*SSY_GRADE = 200 AND*/ EXPECTED_GRADUATION_YEAR =2020  THEN 200
				 WHEN /*SSY_GRADE = 200 AND*/ EXPECTED_GRADUATION_YEAR =2020  AND [Credits] <6 THEN 190
				 WHEN /*SSY_GRADE = 200 AND*/ EXPECTED_GRADUATION_YEAR =2020  AND [Credits] BETWEEN 6 AND 12.99999 THEN 200
				 WHEN /*SSY_GRADE = 200 AND*/ EXPECTED_GRADUATION_YEAR =2020  AND [Credits] BETWEEN 13 AND 18.99999 THEN 200
				 WHEN /*SSY_GRADE = 200 AND*/ EXPECTED_GRADUATION_YEAR =2020  AND [Credits] >=19 THEN 200

				  WHEN /*SSY_GRADE = 210 AND*/ EXPECTED_GRADUATION_YEAR =2019  THEN 210
				 WHEN /*SSY_GRADE = 210 AND*/ EXPECTED_GRADUATION_YEAR =2019  AND [Credits] <6 THEN 190
				 WHEN /*SSY_GRADE = 210 AND*/ EXPECTED_GRADUATION_YEAR =2019  AND [Credits] BETWEEN 6 AND 12.99999 THEN 200
				 WHEN /*SSY_GRADE = 210 AND*/ EXPECTED_GRADUATION_YEAR =2019  AND [Credits] BETWEEN 13 AND 18.99999 THEN 210
				 WHEN /*SSY_GRADE = 210 AND*/ EXPECTED_GRADUATION_YEAR =2019  AND [Credits] >=19 THEN 210

				  WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR =2018  THEN 220
				 WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR =2018  AND [Credits] <6 THEN 190
				 WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR =2018  AND [Credits] BETWEEN 6 AND 12.99999 THEN 200
				 WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR =2018  AND [Credits] BETWEEN 13 AND 18.99999 THEN 210
				 WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR =2018  AND [Credits] >=19 THEN 220

				
				 WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR <2018  AND [Credits] <6 THEN 190
				 WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR <2018  AND [Credits] BETWEEN 6 AND 12.99999 THEN 200
				 WHEN /*SSY_GRADE = 220 AND*/ EXPECTED_GRADUATION_YEAR <2018  AND [Credits] BETWEEN 13 AND 18.99999 THEN 210
				 WHEN  EXPECTED_GRADUATION_YEAR <2018  AND [Credits] >=19 THEN 220 

			ELSE ''
		END AS UPDATED_GRADE_LEVEL 
...
WHERE
   ...
   LEFT JOIN
    ...
    ON
    EVERYTHING.UPDATED_GRADE_LEVEL=[NewGrade].[VALUE_CODE]
