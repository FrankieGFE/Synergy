...
SELECT HIST.STUDENT_GU, RN, STU_PGM_ELL_HIS_GU FROM 

(
SELECT 
	DISTINCT HIST.STUDENT_GU, SIS_NUMBER
 FROM
...
ON
ALTKIDS.STUDENT_GU = HIST.STUDENT_GU
...
WHERE
DELETES2.STU_PGM_ELL_HIS_GU = rev.EPC_STU_PGM_ELL_HIS.STU_PGM_ELL_HIS_GU
