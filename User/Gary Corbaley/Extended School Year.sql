...
SELECT
	...
	,[STUDENT_PARENT_1].[LIVES_WITH]
	,[RELATIONSHIP_1].[VALUE_DESCRIPTION]
	,[PARENT_2].[FIRST_NAME] + ' ' + [PARENT_2].[LAST_NAME] AS [PARENT_2/GAURDIAN]
	,[STUDENT_PARENT_2].[LIVES_WITH]
	,[RELATIONSHIP_2].[VALUE_DESCRIPTION]
...
FROM
	...
	LEFT OUTER JOIN
	APS.LookupTable ('K12', 'RELATION_TYPE') AS [RELATIONSHIP_1]
	ON
	[STUDENT_PARENT_1].[RELATION_TYPE] = [RELATIONSHIP_1].[VALUE_CODE]
	...
	LEFT OUTER JOIN
	APS.LookupTable ('K12', 'RELATION_TYPE') AS [RELATIONSHIP_2]
	ON
	[STUDENT_PARENT_2].[RELATION_TYPE] = [RELATIONSHIP_2].[VALUE_CODE]
