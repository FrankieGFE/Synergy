...
FROM
	OPENROWSET (
			...
			'SELECT * FROM Roosevelt_Assessment_Data_And_Grades.csv'  
		)AS [FILE]
	...
	AND [ENROLLMENTS].[ORGANIZATION_YEAR_GU] = [PERIOD_ATTENDANCE].[ORGANIZATION_YEAR_GU]
	
--WHERE
--	[STUDENT].[SIS_NUMBER] = '769462797'
