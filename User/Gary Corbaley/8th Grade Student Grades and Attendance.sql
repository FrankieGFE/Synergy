...
SELECT DISTINCT
	...
	,[ATTENDANCE].[MISSING PERIODS] AS [TOTAL MISSING PERIODS]
...
FROM
	...
	ON
	[ASOF_ENROLLMENTS].[STUDENT_GU] = [GRADES].[STUDENT_GU]
	...
	ON
	[ASOF_ENROLLMENTS].[STUDENT_GU] = [ATTENDANCE].[STUDENT_GU]
	
WHERE
	[ASOF_ENROLLMENTS].[GRADE] = '08'
	AND [GRADES].[GRADE_PERIOD] = 'S1 Grade'
	AND [GRADES].[DEPARTMENT] IN ('Eng','Math')
	
	--AND [STUDENT_DETAILS].[SIS_NUMBER] = '100040864'
...
--	APS.StudentGrades AS [GRADES]
--	ON
--	[SCHEDULE].[SECTION_GU] = [GRADES].[SECTION_GU]