...
SELECT
	...
	,[RevYear].[SCHOOL_YEAR]
	,[RevYear].[EXTENSION]
	,[StudentSchoolYear].[SCHOOL_RESIDENCE_GU]
FROM
...
SELECT
	...
	,[ASOF_ENROLLMENTS].[SCHOOL_RESIDENCE_GU]
	,[SOR].[ORGANIZATION_NAME] AS [SCHOOL OF RESIDENCE]
...
FROM
	...
	AND [ASOF_ENROLLMENTS].[SCHOOL_YEAR] = [SCHOOL_GRID].[SCHOOL_YEAR]
	...
	LEFT OUTER JOIN
	rev.REV_ORGANIZATION AS [SOR]
	ON
	[ASOF_ENROLLMENTS].[SCHOOL_RESIDENCE_GU] = [SOR].[ORGANIZATION_GU]
	
WHERE
	--[ASOF_ENROLLMENTS].[GRADE] IN ('09','10','11','12')
	--AND [SCHOOL_GRID].[SR_HIGH_SCHOOL_GU] != [ASOF_ENROLLMENTS].[SCHOOL_RESIDENCE_GU]
	
	--[ASOF_ENROLLMENTS].[GRADE] IN ('06','07','08')
	--AND [SCHOOL_GRID].[JR_HIGH_SCHOOL_GU] != [ASOF_ENROLLMENTS].[SCHOOL_RESIDENCE_GU]
	
	[ASOF_ENROLLMENTS].[GRADE] IN ('01','02','03','04','05')
	AND [SCHOOL_GRID].[ELEM_SCHOOL_GU] != [ASOF_ENROLLMENTS].[SCHOOL_RESIDENCE_GU]
