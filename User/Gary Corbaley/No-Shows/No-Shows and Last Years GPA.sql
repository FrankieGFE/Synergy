...
SELECT
	*
FROM
	@SYNERGYNOSHOWS AS [SYNERGY_NO_SHOWS]
	
	LEFT OUTER JOIN
	APS.CumulativeGPA AS [GPA]
	ON
	[SYNERGY_NO_SHOWS].[SIS_NUMBER] = [GPA].[ID_NBR]
...
--	--) AS [Attendance]	
--	--ON
--	--[SYNERGY_NO_SHOWS].[SIS_NUMBER] = [Attendance].[ID_NBR]
...
--	--ON
--	--[SYNERGY_NO_SHOWS].[SIS_NUMBER] = [DISIPLINE_ACTIONS].[ID_NBR]
...
--WHERE
--	[SYNERGY_NO_SHOWS].[SYNERGY_GRADE_LEVEL] = '09'