...
FROM
	...
	(
		SELECT 
		  ...
		  ,CASE WHEN [MAIL_ADDRESS].[ADDRESS] IS NULL THEN [HOME_ADDRESS].[ADDRESS] ELSE [MAIL_ADDRESS].[ADDRESS] END AS [MAIL_ADDRESS]
			,CASE WHEN [MAIL_ADDRESS].[ADDRESS2] IS NULL THEN [HOME_ADDRESS].[ADDRESS2] ELSE [MAIL_ADDRESS].[ADDRESS2] END AS [MAIL_ADDRESS_2]
			,CASE WHEN [MAIL_ADDRESS].[CITY] IS NULL THEN [HOME_ADDRESS].[CITY] ELSE [MAIL_ADDRESS].[CITY] END AS [MAIL_CITY]
			,CASE WHEN [MAIL_ADDRESS].[STATE] IS NULL THEN [HOME_ADDRESS].[STATE] ELSE [MAIL_ADDRESS].[STATE] END AS [MAIL_STATE]
			,CASE WHEN [MAIL_ADDRESS].[ZIP_5] IS NULL THEN [HOME_ADDRESS].[ZIP_5] ELSE [MAIL_ADDRESS].[ZIP_5] END AS [MAIL_ZIP]
		...
		ON
		pper.HOME_ADDRESS_GU = [HOME_ADDRESS].[ADDRESS_GU]
	) AS [STU_PARENT]
	ON
