...
/****** Object:  UserDefinedFunction [APS].[LCEStudentsNeedingTestingAsOf]    Script Date: 04/18/2016 10:21:55 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [APS].[LCEStudentsNeedingTestingAsOf](@AsOfDate DATE)
RETURNS TABLE
AS
RETURN
