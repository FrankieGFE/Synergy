...
--/****** Object:  View [APS].[CumGPA]    Script Date: 06/20/2016 13:55:58 ******/
--SET ANSI_NULLS ON
--GO
...
--CREATE VIEW [APS].[CumGPA] AS

CREATE FUNCTION [APS].[CumGPAForYear](@SCHOOL_YEAR INT)
RETURNS TABLE
AS
RETURN	
...
FROM	
	...
	FROM		
		...
		FROM	
			...
			ON
			[GPA].[STUDENT_SCHOOL_YEAR_GU] = [StudentSchoolYear].[STUDENT_SCHOOL_YEAR_GU]
