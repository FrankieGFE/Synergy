...
SELECT
	...
	--,[STUDENT].[ELL_STATUS]
	--,[STUDENT].[SPED_STATUS]
	--,[PERIOD_ATT].[Full Days Unexcused]
	--,[PERIOD_ATT].[Half Days Unexcused]
	,[PERIOD_ATT].[PERIOD TARDY]
FROM
	(
	SELECT
		*
	...
	WHERE
		...
		AND SCHOOL_CODE IN ('207', '255', '260', '270', '276', '279', '285', '333', '379', '405', '410', '413', '415', '416', '425', '427', '445', '460', '470', '496', '520', '540', '570', '576')
	...
	--SELECT	
	--	[ATT].[SIS_NUMBER]
	--	,SUM([ATT].[Full Days Unexcused]) AS [Full Days Unexcused]
	--	,SUM([ATT].[Half Days Unexcused]) AS [Half Days Unexcused]
	--	,SUM([ATT].[Total Unexcused]) AS [Total Unexcused]
	--FROM
	--	APS.PeriodUnexcusedAsOf(@AsOfDate) AS [ATT]
	--GROUP BY
	--	[ATT].[SIS_NUMBER]
	--) AS [PERIOD_ATT]
	--ON
	...
	ON
	[STUDENT].[STUDENT_GU] = [PERIOD_ATT].[STUDENT_GU]
