...
FROM
	...
	WHERE
		...
		[ENROLLMENTS].[SCHOOL_CODE] BETWEEN '200' AND '399'
...
WHERE
	[ENROLLMENTS].[RN] = 1
	--AND [DAILY_ATTENDANCE].[DAILY EXCUSED] > 0
	--AND [DAILY_ATTENDANCE].[DAILY UNEXCUSED] = 0
	--AND [STUDENT].[SIS_NUMBER] = '980004421'
	
	--AND [DAILY_ATTENDANCE].[UF] != 0