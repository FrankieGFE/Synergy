...
SELECT
	...
	,[DAILY_ATTENDANCE].[Full-Day Excused] AS [ELEM_FULL_EX]
	,[DAILY_ATTENDANCE].[Full-Day Unexcused] AS [ELEM_FULL_UN]
	,[DAILY_ATTENDANCE].[Half-Day Excused] AS [ELEM_HALF_EX]
	,[DAILY_ATTENDANCE].[Half-Day Unexcused] AS [ELEM_HALF_UN]
	,[PERIOD_ATTENDANCE].[Full Days Unexcused] AS [SEC_FULL_UN]
	,[PERIOD_ATTENDANCE].[Half Days Unexcused] AS [SEC_HALF_UN]
...
FROM
	...
	LEFT OUTER JOIN
	APS.DailyAttendanceAsOf('05/22/2015') AS [DAILY_ATTENDANCE]
	ON
