...
--	,[CURRENT_ENROLLMENTS].[GRADE] AS [CURRENT GRADE]
	...
	SET [StudentSchoolYear].[PREVIOUS_YEAR_END_STATUS] = CASE WHEN [PREVIOUS_ENROLLMENTS].[YEAR_END_STATUS] IS NULL THEN 'P' ELSE [PREVIOUS_ENROLLMENTS].[YEAR_END_STATUS] END --AS [PREVIOUS_YEAR_END_STATUS]
