...
SELECT
	...
	,CASE WHEN [StudentSchoolYear].[EXCLUDE_ADA_ADM] = 2 THEN 'CONCURRENT'
		WHEN [StudentSchoolYear].[EXCLUDE_ADA_ADM] = 1 THEN 'NON ADA/ADM'
...
SELECT DISTINCT
	...
	,[SCHEDULE].[BADGE_NUM]
	,[ENROLLMENTS].[SCHOOL_NAME] AS [HOME_SCHOOL_LOCATION]
	,[SCHEDULE].[ORGANIZATION_NAME] AS [COURSE_LOCATION]
	,[StudentSchoolYear].[EXCLUDE_ADA_ADM] AS [ADA/ADM CODE]
	,CASE WHEN [StudentSchoolYear].[EXCLUDE_ADA_ADM] = 2 THEN 'CONCURRENT'
		WHEN [StudentSchoolYear].[EXCLUDE_ADA_ADM] = 1 THEN 'NON ADA/ADM'
		ELSE '' END AS [CONCURRENT]
...
WHERE
	...
	--AND [STUDENT].[SIS_NUMBER] = '100096577'