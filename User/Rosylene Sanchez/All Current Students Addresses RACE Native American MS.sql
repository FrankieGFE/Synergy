...
*
* Intial Request: All active Middle School students from 2015-2016 school year (R) who have any of the 5 race indicator = Native American
*
...
FROM	(
		...
		WHERE	SCHOOL_YEAR = '2015' 
				...
				AND CSMDETAIL.grade IN ( '06', '07', '08')	-- MIDDLE SCHOOL
