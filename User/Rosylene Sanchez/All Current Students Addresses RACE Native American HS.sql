...
*
* Intial Request: All active High School students from 2015-2016 school year (R) who have any of the 5 race indicator = Native American
*
...
FROM	(
		...
		WHERE	SCHOOL_YEAR = '2015' 
				...
				AND CSMDETAIL.grade IN ( '09', '10', '11', '12')	-- HIGH SCHOOL
