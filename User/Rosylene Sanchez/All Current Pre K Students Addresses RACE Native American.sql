...
*
* Intial Request: All active Pre K students from 2015-2016 school year (R) who have any of the 5 race indicator = Native American
*
...
FROM	(
		...
		WHERE	SCHOOL_YEAR = '2015' 
				...
				AND CSMDETAIL.grade IN ( 'P1', 'P2', 'PK')	-- Pre K
