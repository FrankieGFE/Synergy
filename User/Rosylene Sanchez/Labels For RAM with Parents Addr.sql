...
FROM   OPENROWSET ( 'Microsoft.ACE.OLEDB.12.0', 
		...
		SELECT sis_number, 
                ...
                parent_first_name,
				ADDRESS,
				ENR15.SCHOOL_YEAR AS [2015 ENR],
				ENR16.SCHOOL_YEAR AS [2016 ENR]
		...
		FROM   rev.epc_stu AS STU	--HAS SIS_NUMBER, STUDENT_GU,
				...
				INNER JOIN (SELECT SPAR.student_gu, 
									...
									CASE
										WHEN ADDR.ADDRESS is not null THEN ADDR.ADDRESS + ', ' + ADDR.CITY +', '+ ADDR.STATE + ', ' + ADDR.ZIP_5
										ELSE ADDR2.ADDRESS + ', ' + ADDR2.CITY + ', ' + ADDR2.STATE + ', ' + ADDR2.ZIP_5
									END AS ADDRESS
