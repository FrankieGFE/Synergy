...
FROM   OPENROWSET ( 'Microsoft.ACE.OLEDB.12.0', 
		...
		LEFT JOIN (SELECT sis_number, 
				          ...
				          ADDRESS,
						  CASE
						    WHEN ENR15.SUMMER_WITHDRAWL_CODE IS NOT NULL THEN ' '
							ELSE CAST(ENR15.SCHOOL_YEAR AS VARCHAR)
						  END AS [2015-2016 ENR],
						  CASE
						    WHEN ENR16.SUMMER_WITHDRAWL_CODE IS NOT NULL THEN ' '
							ELSE CAST(ENR16.SCHOOL_YEAR AS VARCHAR)
						  END AS [2016-2017 ENR]
				   ...
				   FROM   rev.epc_stu AS STU	--HAS SIS_NUMBER, STUDENT_GU,
					  ...
					  LEFT JOIN APS.StudentEnrollmentDetails AS ENR16
						     ON ENR16.SCHOOL_YEAR = '2016'	--2015-2016
