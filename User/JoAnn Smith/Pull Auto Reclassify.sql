...
--    SET
--    [YEAR_END_STATUS]='P' --promoted
--    ,[FTE]=1.00 --they said this doesn't matter, but just for good measure.

--WHERE
--    [YEAR_GU]=(SELECT [YEAR_GU] FROM [rev].[REV_YEAR] WHERE [SCHOOL_YEAR]=2016 AND [EXTENSION]='R')
--    AND [STATUS] IS NULL
--    AND [EXCLUDE_ADA_ADM] IS NULL
--    AND ([YEAR_END_STATUS] IS NULL OR [YEAR_END_STATUS]='')
