...
(
SELECT 
          ROW_NUMBER () OVER (PARTITION BY SIS_NUMBER, SCORE_DESCRIPTION ORDER BY STUDENTTEST.ADMIN_DATE DESC) AS RN
          ,PERSON.FIRST_NAME
       ,PERSON.LAST_NAME
...
WHERE
1 = 1
       AND TEST_NAME = 'ACCESS'
          --AND TEST_NAME LIKE '%ADC%'
       AND SIS_NUMBER = '970110724'
...
--AND SIS_NUMBER = '77212'
--AND SCORE_DESCRIPTION = 'OVERALL LP'
ORDER BY  SIS_NUMBER, LAST_NAME
--ORDER BY TEST_SCORE
