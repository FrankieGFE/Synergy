declare @School uniqueidentifier = '41AE38C9-9A90-4672-95B4-399B3BDF840A '
declare @Term nvarchar(10) = '%'
declare @Year uniqueidentifier = 'A3F9F1FB-4706-49AA-B3A3-21F153966191'

--select * from rev.rev_organization where organization_name like '%Eldorado%'
--select * from rev.rev_year 
;with Main as
(
SELECT
	SCHOOL_NAME
