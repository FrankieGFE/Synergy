/* 
Pull High School Students with Perfect Attendance

Written by:		Andy G
Modified by:	JoAnn Smith
Modified Date:	6/7/2017

Added student email and parent emails
Added 592 and Tran to the exclusion list
*/
...
--select * from PERIOD_ATTENDANCE where student_gu = '701EDBC8-0956-4557-85EB-04E82A9D193B'
...
--select * from ATTENDANCE_DETAILS where SIS_NUMBER = 102817665
,STUDENT_DETAILS
AS
(
SELECT --TOP 100
...
WHERE
	[Enrollments].[SCHOOL_CODE] NOT IN ('022','048','058','188', '233','162','611', '533', '592', '846','847','848','900','901','910', 'tran')
...
--SELECT * FROM STUDENT_DETAILS where SIS_NUMBER = 102817665
,PARENT_EMAIL
AS
(
SELECT
...
--SELECT * FROM PARENT_EMAIL where student_gu = '1F1F62DF-99A1-4EA1-9238-40343693457C'
SELECT
	SD.STUDENT_GU,
	SD.[FIRST_NAME],
	SD.[LAST_NAME],
...
--where
--	sd.student_gu = '701EDBC8-0956-4557-85EB-04E82A9D193B'
GROUP BY
	sd.student_gu,
	SD.[PERIOD EXCUSED],
	SD.[SIS_NUMBER],
