...
from
	Students r
LEFT join
	aps.EnrollmentsForYear('A3F9F1FB-4706-49AA-B3A3-21F153966191') sed
on
...
left join
	rev.REV_ORGANIZATION o
on
	sed.ORGANIZATION_gu = o.ORGANIZATION_GU
WHERE
	SUMMER_WITHDRAWL_DATE IS NULL
GROUP BY
	R.SIS_NUMBER, O.ORGANIZATION_NAME, SED.EXCLUDE_ADA_ADM
)
--SELECT * FROM NumberofSchoolsAttended WHERE SIS_NUMBER = '980037375'
,Count_Schools
as
(
select
...
WHERE
	N.EXCLUDE_ADA_ADM IS NULL
GROUP BY
	SIS_NUMBER
	--SCHOOL_NAME
)
--SELECT * FROM COUNT_SCHOOLS WHERE sis_number = '104599188'
,I_READY_MATH
AS
(
SELECT 
...
select
	...
	d.FIRST_NAME,
	d.LAST_NAME,
	convert(VARCHAR(10), BIRTH_DATE, 101) AS BIRTH_DATE,
	d.SPED_STATUS,
	d.GRADE,
	d.ORGANIZATION_NAME,
	d.PARENT_FIRST_NAME,
	...
	d.RELATION_TYPE,
	d.RELATIONSHIP,
	d.NUMBER_OF_SCHOOLS_ATTENDED,
	d.I_READY_MATH,
	d.I_READY_MATH_PERF_LEVEL,
	d.I_READY_ELA, 
	d.I_READY_ELA_PERF_LEVEL
