SELECT
	...
	,CASE WHEN [General/Basic course] IS NOT NULL THEN 'Y' ELSE 'N' END AS [CL General Core Course]
...
FROM
	...
	(
		Max(CourseLevel)
		FOR CourseLevel IN ([Articulation course (SPED)],[BEP], [Dual credit course], [Elective course], [ESL], [General/Basic course], [Gifted], [Honors course] ,[Industry/occupational certification course],[Lab], [Intervention course], [No credit])
	) AS PivotTable