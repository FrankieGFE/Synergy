...
--************************************************************************
-- NOTE:  DIEBELS WAS REPLACED BY ISTATION FOR THE SCHOOL YEAR 2016
-- use product type = 'ISTATION'
--************************************************************************
SELECT [School Year], [Student APS ID], [Test Name], [Grade Level], Tier, [Raw Score], [Secondary Result]  FROM
(SELECT 
 ...
 DESC) AS RN,
    ...
    TEST_RAW_SCORE AS [Raw Score],
    TEST_SECONDARY_RESULT as [Secondary Result],
