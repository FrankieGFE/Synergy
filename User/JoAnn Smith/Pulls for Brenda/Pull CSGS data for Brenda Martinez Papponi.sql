...
group by
	 s.[CURRENT GRADE LEVEL], LU.VALUE_DESCRIPTION, PERFORMANCE_LEVEL
)
--SELECT * FROM PERF1
--ORDER BY
--	GRADE, [DESCRIPTION], PERFORMANCE_LEVEL
, PERF2
AS
(
	SELECT
		...
		CASE
			...
			WHEN PERFORMANCE_LEVEL IN ('REACH', 'C-PRO', 'FEP', 'ADV', 'INITIAL FEP') THEN 6
