...
Revised:		7/26/2017 - Added ELL - Exited 4 years, exited 5 plus years and expected graduation of 2014
*/
...
SELECT
	...
	LEFT JOIN
	REV.EPC_STU_PGM_ELL_HIS_NEW EL
	ON
	EL.STUDENT_GU = BS.STUDENT_GU
	...
	AND EXPECTED_GRADUATION_YEAR IN ('2014','2015', '2016')
)
